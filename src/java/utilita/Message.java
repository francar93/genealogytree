...
public class Message {
    ...
    static {
        ...
        //errore Cognome
        map.put("surname_1", "Il cognome deve essere alfanumerico");
        map.put("surname_2", "Il cognome è corto");
        map.put("surname_3", "Il cognome è lungo");
        ...
        map.put("dec", "Richiesta cancellata");
        /* OTHER */
        ...
        /* SPOUSE */
        map.put("sp_alr", "Non Autorizzato:  Hai gia un partner");
        map.put("sp_alr1", "Non Autorizzato:  L'utente selezionato ha già un partner");
        map.put("sp_gen", "Non Autorizzato:  Non puoi avere lo stesso sesso del tuo partener");
        map.put("sp_your", "Non Autorizzato:  Questo utente è gia il tuo partner");
        map.put("sp_sib", "Non Autorizzato:  Il tuo partner non può essere tuo fratello/tua sorella");
        map.put("sp_anc", "Non Autorizzato:  Il tuo partner non può essere un tuo antenato");
        map.put("sp_off", "Non Autorizzato:  Il tuo partner non può essere tuo discendente");
        /* MOTHER */
        ...
        map.put("mot_anc", "Non Autorizzato:  Tua madre non può essere un tuo antenato");
        map.put("mot_off", "Non Autorizzato:  Tua madre non può essere un tuo discendete");
        /* FATHER */
        map.put("fat_alr", "Non Autorizzato:  Hai gia un padre");
        map.put("fat_your", "Non Autorizzato:  Questo utente è già tuo padre");
        map.put("fat_sib", "Non Autorizzato:  Tuo padre non può essere tuo fratello/tua sorella");
        map.put("fat_anc", "Non Autorizzato:  Tuo padre non può essere un tuo antenato");
        map.put("fat_off", "Non Autorizzato:  Tuo padre non può essere un tuo discendente");
        /* CHILD */
        ...
        map.put("ch_mot_sib", "Non Autorizzato:  Tuo/a figlio/a non può essere tuo fratello/tua sorella");
        map.put("ch_mot_anc", "Non Autorizzato:  Tuo/a figlio/a non può essere un tuo discendente");
        map.put("ch_mot_off", "Non Autorizzato:  Tuo/a figlio/a non può essere un tuo antenato");
        map.put("ch_fat_alr", "Non Autorizzato:  Questo utente ha già un padre");
        map.put("ch_fat_your", "Non Autorizzato:  Questo utente è già tuo figlio");
        map.put("ch_fat_sib", "Non Autorizzato:  Tuo/a figlio/a non può essere tuo fratello/tua sorella");
        map.put("ch_fat_anc", "Non Autorizzato:  Tuo/a figlio/a non può essere un tuo antenato");
        map.put("ch_fat_off", "Non Autorizzato:  Tuo/a figlio/a non può essere un tuo discendente");
        /* SIBLING */
        ...
        map.put("sib_your", "Non Autorizzato:  Questo utente è già tuo/tua fratello/sorella");
        map.put("sib_1", "Non Autorizzato:  Questo utente non può essere tuo/tua fratello/sorella, perchè questa relazione non è verificabile");
        map.put("sib_2", "Non Autorizzato:  Questo utente non può essere tuo/tua fratello/sorella, perchè ha gia due genitori");
        map.put("sib_3", "Non Autorizzato:  Questo utente non può essere tuo/tua fratello/sorella, perchè non avete gli stessi genitori");
