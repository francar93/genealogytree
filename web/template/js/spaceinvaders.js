...
var SPRITE_SHEET_SRC = 'data:image/png;base64,';
var LEFT_KEY = 75;
var RIGHT_KEY = 76;
var SHOOT_KEY = 65;
...
var Player = SheetSprite.extend({
  init: function() {
    this._super(spriteSheetImg, PLAYER_CLIP_RECT, CANVAS_WIDTH/2, CANVAS_HEIGHT - 10);
...
function setupAlienFormation() {
  ...
  for (var i = 0, len = 2 * 11; i < len; i++) {
    ...
    aliens.push(new Enemy(clipRects, (CANVAS_WIDTH/2 - ALIEN_SQUAD_WIDTH/2) + ALIEN_X_MARGIN/2 + gridX * ALIEN_X_MARGIN, CANVAS_HEIGHT/8.25 - gridY * 40));
    alienCount++;
  }
}
  ...
  for (var i = 0, len = aliens.length; i < len; i++) {
    ...
    if (alien.bullet !== null && checkRectCollision(alien.bullet.bounds, player.bounds)) {
      if (player.lives === 0) {
       ...
       particleManager.createExplosion(player.position.x, player.position.y, '#00ffff', 100, 8,8,6,0.001,40);
       player.position.set(CANVAS_WIDTH/2-120, CANVAS_HEIGHT - 10);
       player.lives--;
        break;
      }
